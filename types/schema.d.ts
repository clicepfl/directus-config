...
export type Schema = {
  ...
  save_the_date: components["schemas"]["SaveTheDate"][];
  ...
  subsonic: components["schemas"]["Subsonic"][];
  ...
  game_star: components["schemas"]["GameStar"][];
  galleries: components["schemas"]["galleries"][];
};
